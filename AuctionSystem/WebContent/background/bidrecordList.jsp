...
<div class="page-content clearfix">
    <div id="Member_Ratings">
     ...
     <div class="table_menu_list">
	   ...
	   <tbody>
	   <c:forEach items="${list }" var="bidrecord">
			<tr>
				<td>${bidrecord.id}</td>
				<td>${bidrecord.userid}</td>
				<td>${bidrecord.spid}</td>
				<td>${bidrecord.spname}</td>
				<td>${bidrecord.price}</td>
				<td>${bidrecord.createtime}</td>
			...
			<d:page url="bidrecord" servlet="sp.Servlet"/>
